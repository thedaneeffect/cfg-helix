...
./setup.sh go        # Configure GOPATH and install Go tools (gopls, golangci-lint, delve)
...
- **Go Tools**: Installs gopls (language server), golangci-lint (linter), and delve (debugger) via go install
